...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProductFixture.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/StockBinFixture.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ProductFixture(($container->privates['App\\Repository\\StockBinRepository'] ?? $container->load('getStockBinRepositoryService'))), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\StockBinFixture(), 'groups' => []]]);
